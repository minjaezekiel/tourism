...
class User extends Model{
    ...
    static fields ={
        ...
        first_name: new StringField({nullable:false}),
        last_name: new StringField({nullable:false}),
        username: new StringField({nullable:false,unique:true}),
...
module.exports = {User,Analytics,Blog,Contact,Gallery,Testimonials,Tours}